...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "আহ শুনা আসো তুমার পম পম এ একটা উম্মাহ দেই😩😘",
          "আমাকে না ডেকে আমার বস ফাহিম কে দাকেন",
          "বার বার আমাকে ডাকস কেন 😡",
          "Xann আমার ফাহিম বস রে তোমার পম পম খাইতে দাও🫦",
          "যেকেনো প্রয়োজনে আমার বস ফাহিম রে নক করতে পারেন",
          "Assalamulaikum Kemon asen?❤️‍🩹", 
          "Ji sir Ami Fahim ai bot bolen apnr Jnno Ki korte pari?",
          "আহ শোনা আমার আমাকে এতো ডাক্তাছো কেনো আসো বুকে আশো🥱",
          "হুম জান তোমার অইখানে উম্মমাহ😷😘",
          "আসসালামু আলাইকুম বলেন আপনার জন্য কি করতে পারি",
          "আমাকে এতো না ডেকে বস Fahim একটা Gf দে 🙄",
